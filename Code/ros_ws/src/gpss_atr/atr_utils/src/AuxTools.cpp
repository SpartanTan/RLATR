...
// void AuxTools::set_object_header(const std::string frame, const rclcpp::Time& c_time, const int8_t o_class,
...
atr_object_msgs::msg::Object AuxTools::set_object(const int8_t o_class, const int8_t o_type, const int64_t o_id,
                                                  const int64_t o_idx, const std::vector<Eigen::Vector3d>& v_points)
{
  atr_object_msgs::msg::Object aux_object;
  // aux_object.header.frame_id = frame;
  // aux_object.header.stamp = c_time;
  aux_object.object_c.o_class = o_class;
  aux_object.object_t.o_type = o_type;
