...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("atr_path_generator")
    ...
    atr_path_generator_yaml = os.path.join(
        get_package_share_directory("atr_path_generator"), "config", "atr_path_generator.yaml"
    )
